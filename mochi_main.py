...
# no negative prompt and low guidance
frames = pipe(prompt + ("" if random.random()<0.5 else " The animal is small and far away, making it even harder to see. "),
<<<<<<< HEAD
            negative_prompt="blury, out of focus, blurry, pixelated, low resolution, low quality, low detail, low fidelity, low definition, low clarity, low contrast", 
            ...
            guidance_scale=9, #lower guidance scale better results but lower quality 
=======
            ...
            num_inference_steps=32,
            guidance_scale=6,
>>>>>>> 9b57e5efba4ee216120f557355b191f44d9ec1c4
